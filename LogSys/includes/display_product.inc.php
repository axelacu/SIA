               ...
               <div>
                    ...
                    if ($attributes[1] == 0) {
                        echo '
                            ...
                            <input type="number" min="0" max="100" name="qty" id="quantity" value=1><br/>';
                    }
                    echo'
                    ...
                    echo '
                        ...
                        <input type="date" id="date" name="trip-start" value="'.$current_date.'" min="'.$current_date.'" max="2020-12-31">
                        <label for="end" id="date"><b>End date:</b></label>
                        <input type="date" id="date" name="trip-end" value="'.$current_date.'" min="'.$current_date.'" max="2020-12-31">
