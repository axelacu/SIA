...
for($i=1 ; $i<=$_GET['nb_page'] ; $i++){
    if($_GET['page'] == $i) {
        echo '          <a href="recherche.php?page=' . $i . '&nb_page=' . $_GET['nb_page'] . '" class="w3-bar-item w3-black w3-button">' . $i . '</a>';
    }else{
        echo '          <a href="recherche.php?page=' . $i . '&nb_page=' . $_GET['nb_page'] . '" class="w3-bar-item w3-button w3-hover-black">' . $i . '</a>';
    }
}
